...
-(void)initFilmInfo{
    ...
    UIFont *mediulFont  = [UIFont systemFontOfSize:fontSize];
    UIFont *titlefont= [UIFont systemFontOfSize:15.f];
    _filmTitleVi = [[UILabel alloc] initWithFrame:CGRectMake(lbMarginLeft, 2, lbWidth, lbHeight*3)];
    _filmTitleVi.font = titlefont;
//    _filmTitleVi.backgroundColor = [UIColor grayColor];
    _filmTitleVi.lineBreakMode = NSLineBreakByWordWrapping;
    _filmTitleVi.numberOfLines = 0;
    ...
    lbHeight +=lbHeight;
    _filmTitleEn = [[UILabel alloc] initWithFrame:CGRectMake(lbMarginLeft, lbHeight+=rH/3, lbWidth, lbHeight)];
...
-(NSAttributedString *)createAtributedString:(NSString *)strA andString:(NSString *)strB{
    UIFont *arialFont = [UIFont fontWithName:@"HelveticaNeue" size:fontSize];
    ...
    UIFont *VerdanaFont = [UIFont fontWithName:@"HelveticaNeue" size:fontSize-1];
    ...
    [vAttrString addAttribute:NSForegroundColorAttributeName value:[UIColor grayColor] range:(NSMakeRange(0, strB.length))];
