...
//    _title.text = @"Nội dung phim";
    _title.font = [UIFont fontWithName:@"HelveticaNeue" size:9.0];
...
//    _title.backgroundColor = [UIColor greenColor];
    ...
    _movieName.text =@"";
    _movieName.alpha = 0.7f;
    _movieName.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:11.0];
//    _movieName.backgroundColor = [UIColor greenColor];
    ...
    _movieDescription.font = [UIFont fontWithName:@"HelveticaNeue" size:10.0];
...
//    UILabel *oldlb= [_m]
    ...
    testLabel.tag= 11;
    testLabel.alpha = 0.7f;
    testLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:10.0];
