...
@interface MainViewController () <CenterHolderDelegate, UIGestureRecognizerDelegate
>

@property (nonatomic, strong) CenterHolderViewController *CenterXViewController;
...
-(void)setupView {
    ...
    //    self.CenterXViewController.indexTagView = indexTab;
        ...
        [self.CenterXViewController setDelegate:self];
        ...
        self.CenterXViewController = [[NationViewController alloc] initWithTag:indexTab];
        //    self.CenterXViewController.indexTagView = indexTab;
        self.CenterXViewController.view.tag = CENTER_TAG;
        [self.CenterXViewController setDelegate:self];
        [self.view addSubview:self.CenterXViewController.view];
...
-(void)resetMainView {
	...
	if (_leftPanelViewController != nil) {
        ...
        [_CenterXViewController setLeftButtonTag:1];
		self.showingLeftPanel = NO;
	}
	if (_rightPanelViewController != nil) {
		[self.rightPanelViewController.view removeFromSuperview];
		self.rightPanelViewController = nil;
        [_CenterXViewController setRightButtonTag:1];
	...
	[UIView animateWithDuration:SLIDE_TIMING delay:0 options:UIViewAnimationOptionBeginFromCurrentState animations:^{
	 ...
	 completion:^(BOOL finished) {
		 if (finished) {
             ...
             [_CenterXViewController setRightButtonTag:0];
		 }
	 }];
}
...
-(void)movePanelRight {
	...
	[UIView animateWithDuration:SLIDE_TIMING delay:0 options:UIViewAnimationOptionBeginFromCurrentState animations:^{
	 ...
	 completion:^(BOOL finished) {
		 if (finished) {
             [_CenterXViewController setLeftButtonTag:0];
		 }
	 }];
}
