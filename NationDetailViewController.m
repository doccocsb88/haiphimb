...
const NSString *API_URL_LIST_NATION_SINGLE = @"http://www.phimb.net/api/list/538c7f456122cca4d87bf6de9dd958b5/country/";
@interface NationDetailViewController () <RequestImageDelegate>
{
    CGFloat viewWidth;
    CGFloat viewHeight;
    CGFloat marginTop;
...
@end
@implementation NationDetailViewController
@synthesize delegate;
-(id)init{
    self = [super init];
    if(self){
...
-(void)viewDidDisappear:(BOOL)animated{
    ...
    [delegate closePlayerFromNation];
}
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [delegate presentPlayerFromNation:item];
...
//    });
    ...
    _genre = genre;
    paramPage = 1;
    [self performSelectorOnMainThread:@selector(resetListView) withObject:nil waitUntilDone:NO];
...
-(void)callWebService{
    NSLog(@"call API");
    NSString *WS_URL = [NSString stringWithFormat:@"%@%@/%d",API_URL_LIST_NATION_SINGLE,_genre.key,paramPage];
