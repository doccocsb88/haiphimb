...
-(void)initRelateFilmCollection{
    ...
    _listRelateFilm = [[UICollectionView alloc] initWithFrame:CGRectMake(10, 5, _viewWidth - 20  , _viewHeight - 45) collectionViewLayout:flowLayout];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    dispatch_async(dispatch_get_global_queue( DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^(void){
        ...
        Episoder *epi = [filmData objectAtIndex:indexPath.row];
